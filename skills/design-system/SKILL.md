...
> **Version** : 1.0.0 | Upstream robonuggets/design-system — extract brand → `design-system.html` + `brand-book-a4.html` + `brand-book-a4.pdf` (A4 portrait print-ready)
> **Integration Orni** : voir `README-ORNI.md` (origine + workflow combiné avec `frontend-slides --style`)
...
## Combinaison avec frontend-slides (workflow Orni)

`design-system` produit les **artifacts publics partageables** (HTML scrollable + PDF A4). `frontend-slides` consomme ensuite la palette/typo extraite pour générer des **decks brandés**.

```
1. /design-system https://example.com
   → design/design-system.html + design/brand-book-a4.pdf
...
Voir `README-ORNI.md` pour détails.
